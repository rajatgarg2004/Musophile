...
const Elite = () => {
    return (
        <div className="hello">
            ...
            <div className="Main1" id="Main123" style={{ "fontFamily": "Arial, Helvetica, sans-serif" }}>
                <div className="explain1" style={{ "marginLeft": "110px" }}>
                    <h1 id="Pick" style={{ "marginTop": "60px", "fontSize": "40px", " marginBottom": "10px" }}>Elite Subscription</h1>
                    ...
                    <div className="university">
                        <span style={{ "left": "15px", "top": "17px", "fontSize": "24px", "fontWeight": "bolder" }}>Special discount for eligible students in
                            university</span>
                            <button style={{ "fontSize": "14px", "fontWeight": "bold", "borderRadius": "30px", "border": "2px solid black", "backgroundColor": "white", "width": "116px", "height": "52px", "padding": "14px 10px", "letterSpacing": "-0.5px", "marginLeft": "40px", "top": "15px" }}><a style={{"textDecoration":"none","color":"black"}} href="https://www.spotify.com/in-en/student/" target="_blank">Learn More</a></button>
                    </div>
                </div>
            </div>

            <footer >
                <div style={{ "width": "1440px", "height": "600px", "backgroundColor": "black" }}>
                    <div style={{ "top": "70px", "left": "150px", "width": "1170px", "height": "500px" }}>
                        <div className="about1">
                            <li style={{ "display": "inline", "left": "-100px" }}><img src={Logo} className="img2" alt="Logo" /></li>
                            <li className="hello1"><a className="pos" id="nav1" style={{ "left": "-90px" }} href="/">Musophile</a></li>
                            <div style={{ "display": "inline-block", "width": "900px", "height": "500px", "verticalAlign": "top" }}>
                                <div style={{ "display": "inline-block", "left": "20px", "top": "-50px", "fontFamily": "Arial, Helvetica, sans-serif", "letterSpacing": "1px" }}>
                                ...
                                <div style={{ "display": "inline-block", "left": "150px", "top": "-49px", "fontFamily": "Arial, Helvetica, sans-serif", "letterSpacing": "1px" }}>
                                ...
                                <a href="https://www.linkedin.com/in/rajat-garg-72b15a226/"target="_blank"><i className="fab fa-linkedin fa-2x"  style={{ "color": "#ffffff", "padding": "15px", "marginRight": "10px", "left": "340px", "top": "-120px", "display": "inline-block", "borderRadius": "50px", "border": "none", "backgroundColor": "#222326", "cursor": "pointer" }}></i></a>
                                <a href="https://github.com/rajatgarg2004?tab=repositories" target="_blank"><i className="fab fa-github fa-2x" style={{ "color": "#ffffff", "padding": "15px", "marginRight": "10px", "left": "340px", "top": "-120px", "display": "inline-block", "borderRadius": "50px", "border": "none", "backgroundColor": "#222326", "cursor": "pointer" }}></i></a>
                                <a href="https://www.hackerrank.com/rajatgarg2004?hr_r=1" target="_blank"><i class="fab fa-hackerrank fa-2x" style={{ "color": "#ffffff", "padding": "15px", "marginRight": "10px", "left": "340px", "top": "-120px", "display": "inline-block", "borderRadius": "50px", "border": "none", "backgroundColor": "#222326", "cursor": "pointer" }}></i></a>
                            </div>
                        </div>
                        <div style={{ "textAlign": "right", "marginBottom": "15px" }}>
                            <span style={{ "color": "#919496", "fontFamily": "Arial, Helvetica, sans-serif", "fontSize": "12px", "left": "-27px", "top": "10px" }}><i className="fas fa-globe" style={{ "color": "#ffffff" }}></i> India (English)  </span>
                        </div>
                        <div style={{ "color": "#919496", "fontFamily": "Arial, Helvetica, sans-serif" }}>
                            <h3 style={{ "display": "inline-block", "fontSize": "12px", "marginRight": "15px" }}>Legal</h3>
                            <h3 style={{ "display": "inline-block", "fontSize": "12px", "marginRight": "15px" }}>Privacy Center</h3>
                            <h3 style={{ "display": "inline-block", "fontSize": "12px", "marginRight": "15px" }}>Privacy Policy</h3>
                            <h3 style={{ "display": "inline-block", "fontSize": "12px", "marginRight": "15px" }}>Cookies</h3>
                            <h3 style={{ "display": "inline-block", "fontSize": "12px", "marginRight": "15px" }}>About Ads</h3>
                            <h3 style={{ "display": "inline-block", "fontSize": "12px", "marginRight": "15px" }}>Accessibility</h3>
                            <span style={{ "color": "#919496", "left": "585px", "fontSize": "12px", "top": "20px" }}><i className="far fa-copyright" style={{ "color": " #ffffff" }}></i> 2023 Musophile</span>
                        </div>
                    </div>
                </div>
            </footer>
