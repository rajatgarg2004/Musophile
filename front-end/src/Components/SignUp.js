...
const SignUp = () => {
    ...
    return (
        <div className="borderHoju">
            <div className="Logo123">
                <img src={Logo} alt="Logo" className="logo12" style={{"left":"287px"}}></img>
                ...
                <h1 style={{ "fontSize": "20px", "marginTop": "30px", "fontWeight": "bolder", "marginLeft": "150px", "color": "white" }}>Enter Your Username</h1>
                ...
                {error && !username && <span className="Help" style={{ "color": "red", "left": "150px", "top": "5px" }}>Enter Valid Username</span>}
                <h1 style={{ "fontSize": "20px", "marginTop": "30px", "fontWeight": "bolder", "marginLeft": "150px", "color": "white" }}>Enter Your Email</h1>
                ...
                {error && !email && <span className="Help" style={{ "color": "red", "left": "150px", "top": "5px" }}>Enter Valid Email</span>}
                <h1 style={{ "fontSize": "20px", "marginTop": "30px", "fontWeight": "bolder", "marginLeft": "150px", "color": "white" }}>Enter the password</h1>
                ...
                <span style={{ "width": "600px", "fontSize": "14px", "fontWeight": "heavy", "color": "grey", "top": "100px", "left": "330px", "display": "block" }}>Have an account?</span>
                <Link to="/Login" style={{ "fontWeight": "bold", "top": "110px", "left": "328px", "color": "white" }}>Log In to Musophile</Link>
            </div>
        </div>
    )
