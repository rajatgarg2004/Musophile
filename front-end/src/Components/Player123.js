...
const Player=()=> {
  ...
  return (
    ...
    <div className="component12">
      ...
      <button className='homer12'><Link to = "/Home" style={{"color":"black","textDecoration":"none","padding-top":"10px","padding-bottom":"10px","padding-left":"6px","padding-right":"6px"}} >Go to Songs</Link></button>
    </div>
    </div>
  );
